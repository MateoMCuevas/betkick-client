...
export class MoneyUserService {
  ...
  getUserBalance() {
    ...
    return this.http.get<any>('https://betkick-api.leandroruhl.com/api/user/balance', {params})
  }
  ...
  sendWithdrawRequest(withdrawAmount: number) {
    ...
    return this.http.post<any>('https://betkick-api.leandroruhl.com/api/user/withdraw', withdrawAmount, {params})
      .subscribe(
        (response) => {
  ...
  sendDepositRequest(depositAmount: number) {
    ...
    return this.http.post<any>('https://betkick-api.leandroruhl.com/api/user/deposit', depositAmount, {params})
      .subscribe(
        (response) => {
